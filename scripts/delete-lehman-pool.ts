/**
 * Delete script for Hays HS Christmas Classic - Lehman Pool
...
async function deleteLehmanPoolTournament() {
  console.log('🗑️  Deleting Hays HS Christmas Classic - Lehman Pool...\n');
  ...
  try {
    ...
    const tournamentsQuery = query(
      ...
      where('name', '==', 'Hays HS Christmas Classic - Lehman Pool')
    );
