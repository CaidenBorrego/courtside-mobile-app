/**
 * Delete script for Hays HS Christmas Classic - Johnson Pool
 * This removes all tournament data to allow for a clean re-seed
 * Run with: npx ts-node scripts/delete-johnson-pool.ts
 */
...
async function deleteJohnsonPoolTournament() {
  console.log('🗑️  Deleting Hays HS Christmas Classic - Johnson Pool...\n');
  ...
  try {
    ...
    const tournamentsQuery = query(
      ...
      where('name', '==', 'Hays HS Christmas Classic - Johnson Pool')
    );
