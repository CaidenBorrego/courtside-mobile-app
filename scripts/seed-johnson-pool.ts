/**
 * Seed script for Hays HS Christmas Classic - Johnson Pool
 * This tournament demonstrates multiple game advancement with losers feeding into a consolation pool
 * Run with: npx ts-node scripts/seed-johnson-pool.ts
 */
...
async function seedJohnsonPoolTournament() {
  console.log('🏀 Creating Hays HS Christmas Classic - Johnson Pool...\n');
  ...
  try {
    ...
    const division = {
      tournamentId,
      name: 'Varsity Boys - Johnson Pool',
      ageGroup: 'Varsity',
      gender: 'boys',
      skillLevel: 'Elite',
      createdAt: Timestamp.now(),
    ...
    const locations = [
      { name: 'Competition Gym', address: 'Johnson High School', city: 'Buda', state: 'TX' },
    ];
    ...
    const championshipBracket = {
      ...
      seeds: [
        { position: 1, teamName: 'Johnson' },
        { position: 2, teamName: 'CHSA' },
        { position: 3, teamName: 'Deer Park' },
        { position: 4, teamName: 'Rouse' },
        { position: 5, teamName: 'Georgetown' },
        { position: 6, teamName: 'Alamo Heights' },
        { position: 7, teamName: 'Akins' },
        { position: 8, teamName: 'Cedar Ridge' },
      ],
      createdAt: Timestamp.now(),
      updatedAt: Timestamp.now(),
    };
    ...
    const round1Game1 = await upsertGame({
      ...
      scoreA: 0,
      scoreB: 0,
      startTime: Timestamp.fromDate(new Date('2025-12-29T09:30:00')),
      locationId: locationIds['Competition Gym'],
      court: 'Competition Gym',
      status: 'scheduled',
    ...
    const round1Game2 = await upsertGame({
      ...
      scoreA: 0,
      scoreB: 0,
      startTime: Timestamp.fromDate(new Date('2025-12-29T11:00:00')),
      locationId: locationIds['Competition Gym'],
      court: 'Competition Gym',
      status: 'scheduled',
    ...
    const round1Game4 = await upsertGame({
      ...
      scoreA: 0,
      scoreB: 0,
      startTime: Timestamp.fromDate(new Date('2025-12-29T13:40:00')),
      locationId: locationIds['Competition Gym'],
      court: 'Competition Gym',
      status: 'scheduled',
    ...
    const quarterGame5 = await upsertGame({
      ...
      scoreA: 0,
      scoreB: 0,
      startTime: Timestamp.fromDate(new Date('2025-12-29T17:40:00')),
      locationId: locationIds['Competition Gym'],
      court: 'Competition Gym',
      status: 'scheduled',
    ...
    const quarterGame6 = await upsertGame({
      ...
      scoreA: 0,
      scoreB: 0,
      startTime: Timestamp.fromDate(new Date('2025-12-29T19:00:00')),
      locationId: locationIds['Competition Gym'],
      court: 'Competition Gym',
      status: 'scheduled',
    ...
    const semiGame7 = await upsertGame({
      ...
      scoreA: 0,
      scoreB: 0,
      startTime: Timestamp.fromDate(new Date('2025-12-30T11:40:00')),
      locationId: locationIds['Competition Gym'],
      court: 'Competition Gym',
      status: 'scheduled',
    ...
    const semiGame8 = await upsertGame({
      ...
      scoreA: 0,
      scoreB: 0,
      startTime: Timestamp.fromDate(new Date('2025-12-30T13:00:00')),
      locationId: locationIds['Competition Gym'],
      court: 'Competition Gym',
      status: 'scheduled',
    ...
    const finalsGame = await upsertGame({
      ...
      scoreA: 0,
      scoreB: 0,
      startTime: Timestamp.fromDate(new Date('2025-12-30T18:20:00')),
      locationId: locationIds['Competition Gym'],
      court: 'Competition Gym',
      status: 'scheduled',
      gameLabel: 'Finals',
    ...
    const consolationGame1 = await upsertGame({
      ...
      scoreA: 0,
      scoreB: 0,
      startTime: Timestamp.fromDate(new Date('2025-12-29T15:00:00')),
      locationId: locationIds['Competition Gym'],
      court: 'Competition Gym',
      status: 'scheduled',
    ...
    const consolationGame3 = await upsertGame({
      ...
      scoreA: 0,
      scoreB: 0,
      startTime: Timestamp.fromDate(new Date('2025-12-30T09:00:00')),
      locationId: locationIds['Competition Gym'],
      court: 'Competition Gym',
      status: 'scheduled',
    ...
    const consolationGame6 = await upsertGame({
      ...
      scoreA: 0,
      scoreB: 0,
      startTime: Timestamp.fromDate(new Date('2025-12-30T15:40:00')),
      locationId: locationIds['Competition Gym'],
      court: 'Competition Gym',
      status: 'scheduled',
    ...
    console.log('📊 Summary:');
    console.log('   - 1 tournament: Hays HS Christmas Classic - Johnson Pool');
    console.log('   - 1 division: Varsity Boys - Johnson Pool');
    console.log('   - 1 location: Competition Gym');
